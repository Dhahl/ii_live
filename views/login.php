	...
	<div class="col-md-5 primaryMenu voffset6">
		...
		<div class="col-md-6">
			<div class="col-md-10 btn-custom text-center" style="border: 0px solid; border-radius: 10px; line-height: 2; font-weight: 900; font-size: 14px; font: Impact, Charcoal, sans-serif;">
				<a href="../login/?publisher=1">PUBLISHER'S AREA</a>
			</div>
					  	...
					  	<div class="col-md-6">
							<div class="alert alert-danger" style="border-radius:25px">
								...
								<div class="col-sx-8 text-center">
			        				<p>Your request has been received and an activation link has been sent to your email address.</p>
  							...
  							<div class="col-lg-8 col-md-10 col-sm-10">
  								...
  								<a href="../?home=1">
									<span class="glyphicon glyphicon-remove-circle  pull-right "	
										title="Home Page" style="font-size: 20px; text-shadow: black 0px 1px 1px; "></span>
								</a>
 								 	<h4  class="text-center">Thank You for Registering with Irish Interest </h4><br/>
									...
									<div class="form-group <?php echo $firstnameErr ; ?>">
  										<label class="col-lg-4 col-md-4 control-label control-label.has-error" for="firstname">First Name</label>
  											<div class="col-md-4 ">
...
<div class="form-group  <?php echo $passwordErr ; ?>">
 <div class="row">
  <label class="col-lg-2 col-md-1 control-label control-label.has-error" for="password">Enter Password</label>
  <div class="col-md-6">
  	<div class="required-field-block">
    	<input type="password" id="password" name="password" placeholder="password" class="form-control input-md" 
...
<div class="form-group  <?php echo $emailErr ; ?>">
	<div class="row">
  		<label class="col-md-3 control-label control-label.has-error" for="email">E-mail Address</label>
  		<div class="col-md-8">
  				<div class="required-field-block">
    				<input type="email" id="email" name="email" placeholder="your e-mail address" class="form-control input-md" 
	...
	if($_SESSION['ok']	===	true)	{	?>
		<div class="row">
		  ...
		  <div class="col-md-8">
			<div class="alert alert-warning text-center" style="border-radius:25px">
        		<a href="#" class="close" data-dismiss="alert">&times;</a>
        			Your request has been received and an activation link has been issued.</p> 
        			<p>Please check your e-mail for instructions on how to proceed.</p> 
        			<p><a  href="../"> click here to Return to Books  </a></p>
        	</div> 
    	   </div>
    	  </div>
...
<div class="form-signin-heading row text-center" style="margin-bottom:20px;">
<?php if($_GET['publisher']	== 1) 
		$title = 'Sign in as Irish Interest Publisher';
		else $title = 'Sign in to Irish Interest';
		echo '<h4>'.$title.'</h4>';
		?>        
