...
<script src="/twitter-bootstrap/twitter-bootstrap-v2/js/bootstrap-popover.js"></script>  
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
 		  <div class="pull-left" style="padding-left:20px;padding-top:5px">
            <div class="media">

    			<img src="./Logo_200.png" style="height:50px" class="img-responsive"  >
...
<!-- Search input-->
   	  <div class="col-md-9 col-xs-9  col-sm-9" style="padding-top:10px; padding-bottom:2px">
...
<!--     <div id="myCarousel" class="carousel slide" style="margin-top:10px">
   ...
   <div class="carousel-inner">
     <div class="active item .fade .in">
        	 img alt="" src="./images/wide-3.png" height="190"  
 		<img alt="" src="./Final Light Green-600.png">
    </div>-->
   <!-- <div class="item .fade .in">
    	img alt="Yeats, Beckett, O'Casey" src="./images/wide-1.png" height="190"> 
		<img alt="" src="./Final Dark Green-600.png" > 
   </div>-->
    <!--div class="item .fade .in">    	
    	< img alt="" src="./images/wide-2.png" height="190">
		<img alt="" src="./Final Dark Green V.4.jpg" height="190"> jpg >
	</div-->
    <!--div class="item .fade .in">
        	< img alt="" src="./images/wide-5.png" height="190">  
		<img alt="" src="./Final Dark Green V.4.png" height="190"> png>
    </div-->
    <!-- div class="item .fade .in">
        	<!-- img alt="" src="./images/wide-4.png" height="190">  
		<img alt="" src="./Final Dark Green V.4.tif" height="190"> tif
    </div>  
    </div>-->
    <!-- Carousel nav 
...
<div class="col-md-2" id="slideshow">
     <!-- img class="img-responsive" src="./images/kellstext1.jpeg"
         alt="">
   <img class="img-responsive" src="./images/bookshop02.jpeg"
         alt="">
     <img class="img-responsive" src="./images/bookshop03_a.jpg"
         alt="">
   <img class="img-responsive" src="./images/bookshop01.jpeg"
         alt="">
     <img class="img-responsive" src="./images/bookshop03_a.jpg"
         alt=""> 
   <img class="img-responsive" src="./Final Dark Green V.4-02-sm.png"
         alt="">
   <img class="img-responsive" src="./Final Dark Green V.4-02-sm.png"
         alt="">
   <img class="img-responsive" src="./Final Dark Green V.4-02-sm.png"
   ...
   <img class="img-responsive" src="./Final Dark Green V.4-02-sm.png"
         alt="">
   <img class="img-responsive" src="./Final Dark Green V.4-100.png"
         alt="">-->
<?php 
	foreach($booklist as $book){ 
   		?><!-- img class="img-responsive" src="./Final Dark Green-200.png" 
         alt=""> --><?php
		if($book->image != "")	{ 
		 	$image	=	"upload/".$book->image;?>
	 	<img class="img-responsive" style="margin-top:10px" src="<?php echo	$image;?>" alt="">
   <!--  img class="img-responsive" src="./Final Light Green-200.png"
         alt=""> -->
		 	<?php }
	}
?>         
...
<div class="col-md-6" >
    ...
    ?>
  	 	 <div class="<?php  echo $imgActive; ?>item .fade .in">
    		<img alt="Yeats, Beckett, O'Casey" src="<?php echo "upload/".$book->image;?>" style="height:190px">
  	 	</div>
 <?php 	
 	$imgActive	=	"";
     	}
...
?>
        ...
        <div class="container-pad" id="property-listings" style="background-color:#FFF5E6" >
...
?></div></div></div>
 ...
 <div class="container col-md-12">
 		<div id="footer">
				...
				All Trademarks acknowledged</small></p></div>
		</div>
<script>  
$(function ()  
