...
$settings['bbname'] = "Irish Interest";
$settings['bburl'] = "http://localhost/framework/forum";
...
$settings['homename'] = "irishinterest";
$settings['homeurl'] = "http://localhost/framework";
