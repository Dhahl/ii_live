...
*/
	...
	/*	
			...
			echo '<br><b>Body:</b>'.$body;
			var_dump($body);
			echo '<br><b>--END body--</b><br>';
		die;
*/
		...
		return($success ? "" : $this->OutputPHPError("An error occurred when sending an e-mail message to that address. Please  contact the Irish Interest Administrator", $php_errormsg));
	}
